      ...
      function direct(id) {
            switch (id) {
                  case 'out':
                        ...
                        break;
                  case 'view':
                        window.open('http://88.99.67.75/getArchiveData.php?pw=0c20fc30c1cfe46df3ebf7eb6224b16e&source=webpage&output=html&id=' + <?php echo e($entry->Web_id); ?>);
                        break;

                  case 'home':
                        window.location.href = "/rawindex/<?php echo e($user); ?>";
                        break;
            }
      }
</script>
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">#<?php echo e($entry->Web_id); ?></h1>
